...
public class BeeEnvironment {
    ...
    private final DefaultBoundedRangeModel hornetAcceleration = new DefaultBoundedRangeModel(4, 1, 0, 21);
    ...
    private final DefaultBoundedRangeModel hornetVelocity = new DefaultBoundedRangeModel(10, 1, 0, 21);
